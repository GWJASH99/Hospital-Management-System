    ...
    <div className={`p-6 md:p-10 font-sans space-y-8 h-full flex flex-col ${dark ? 'text-gray-100' : 'text-gray-900'}`}>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button
          ...
          className="group flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-500 text-white px-6 py-2.5 rounded-xl font-medium shadow-md shadow-blue-500/20 hover:shadow-blue-500/40 hover:-translate-y-0.5 transition-all w-full sm:w-auto"
        >
