export const translations = {
  EN: {
    ...
    loginFormSub: "Sign in to access your premium health dashboard.",
    emailLabel: "Email Address",
    passwordLabel: "Password",
    emailPlaceholder: "example@gmail.com",
    passwordPlaceholder: "Enter your password",
    invalidEmailMsg: "Please enter a valid email address.",
    invalidPassMsg: "Password is too short.",
    loginBtn: "Sign In",
    noAccountText: "Don't have an account?",
    signupLink: "Create an account",
    
    signupFormTitle: "Create an Account",
    signupFormSub: "Join eDoc and experience premium healthcare.",
    nameLabel: "Full Name",
  ...
  HI: {
    ...
    loginFormTitle: "वापसी पर स्वागत है",
    loginFormSub: "अपने प्रीमियम स्वास्थ्य डैशबोर्ड तक पहुंचने के लिए साइन इन करें।",
    emailLabel: "ईमेल पता",
    passwordLabel: "पासवर्ड",
    emailPlaceholder: "example@gmail.com",
    passwordPlaceholder: "अपना पासवर्ड दर्ज करें",
    invalidEmailMsg: "कृपया एक वैध ईमेल पता दर्ज करें।",
    invalidPassMsg: "पासवर्ड बहुत छोटा है।",
    loginBtn: "साइन इन करें",
    noAccountText: "क्या आपके पास खाता नहीं है?",
    signupLink: "एक खाता बनाएँ",

    signupFormTitle: "एक खाता बनाएँ",
    signupFormSub: "eDoc से जुड़ें और प्रीमियम स्वास्थ्य सेवा का अनुभव करें।",
    nameLabel: "पूरा नाम",
    namePlaceholder: "जॉन डो",
    invalidNameMsg: "कृपया एक वैध नाम दर्ज करें।",
    signupBtn: "खाता बनाएँ",
    haveAccountText: "क्या आपके पास पहले से एक खाता है?",
  ...
  PA: {
    ...
    loginFormTitle: "ਵਾਪਸੀ ਤੇ ਸਵਾਗਤ ਹੈ",
    loginFormSub: "ਆਪਣੇ ਪ੍ਰੀਮੀਅਮ ਹੈਲਥ ਡੈਸ਼ਬੋਰਡ ਤੱਕ ਪਹੁੰਚ ਕਰਨ ਲਈ ਸਾਈਨ ਇਨ ਕਰੋ।",
    emailLabel: "ਈਮੇਲ ਪਤਾ",
    passwordLabel: "ਪਾਸਵਰਡ",
    emailPlaceholder: "example@gmail.com",
    passwordPlaceholder: "ਆਪਣਾ ਪਾਸਵਰਡ ਦਰਜ ਕਰੋ",
    invalidEmailMsg: "ਕਿਰਪਾ ਕਰਕੇ ਇੱਕ ਵੈਧ ਈਮੇਲ ਪਤਾ ਦਰਜ ਕਰੋ।",
    invalidPassMsg: "ਪਾਸਵਰਡ ਬਹੁਤ ਛੋਟਾ ਹੈ।",
    loginBtn: "ਸਾਈਨ ਇਨ ਕਰੋ",
    noAccountText: "ਕੀ ਤੁਹਾਡੇ ਕੋਲ ਖਾਤਾ ਨਹੀਂ ਹੈ?",
    signupLink: "ਇੱਕ ਖਾਤਾ ਬਣਾਓ",

    signupFormTitle: "ਇੱਕ ਖਾਤਾ ਬਣਾਓ",
    signupFormSub: "eDoc ਨਾਲ ਜੁੜੋ ਅਤੇ ਪ੍ਰੀਮੀਅਮ ਸਿਹਤ ਸੰਭਾਲ ਦਾ ਅਨੁਭਵ ਕਰੋ।",
    nameLabel: "ਪੂਰਾ ਨਾਮ",
    namePlaceholder: "ਜੌਨ ਡੋ",
    invalidNameMsg: "ਕਿਰਪਾ ਕਰਕੇ ਇੱਕ ਵੈਧ ਨਾਮ ਦਰਜ ਕਰੋ।",
    signupBtn: "ਖਾਤਾ ਬਣਾਓ",
    haveAccountText: "ਕੀ ਤੁਹਾਡੇ ਕੋਲ ਪਹਿਲਾਂ ਹੀ ਖਾਤਾ ਹੈ?",
